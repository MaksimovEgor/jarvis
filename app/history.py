...
def append(session_id: str, user: str, reply: str, tools: list[str], cancelled: bool = False) -> None:
    STORE.mkdir(parents=True, exist_ok=True)
    entry = {"ts": time.time(), "user": user, "reply": reply, "tools": tools, "cancelled": cancelled}
