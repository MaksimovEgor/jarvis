...
голосом её не услышать. В момент срабатывания speaker.py доставляет
объявление на устройство, где таймер поставили: открытый экран — сигнал и
фраза (музыку браузер приглушает сам), свёрнутый — пуш, без подписки — Telegram.
